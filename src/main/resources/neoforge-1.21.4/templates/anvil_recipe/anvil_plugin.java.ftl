...
public class ${JavaModName}AnvilRecipes implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        <#list anvilrecipes as recipe>
            ...
            anvilRecipes.add(factory.createAnvilRecipe(${mappedMCItemToItemStackCode(recipe.leftitem)}, List.of(rightItem.copy()), List.of(${mappedMCItemToItemStackCode(recipe.output)}), this.getPluginUid()));
        </#list>
